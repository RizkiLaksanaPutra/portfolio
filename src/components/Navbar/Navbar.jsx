...
const DrawOutlineButton = ({ children, ...rest }) => {
    return (
        <button
            {...rest}
            className="duration-[400ms] group relative w-fit px-2 py-1 font-satoshi text-accent-400 transition-colors hover:font-medium hover:text-accent-400 cursor-pointer"
        >
            <span>{children}</span>
            {/* TOP */}
